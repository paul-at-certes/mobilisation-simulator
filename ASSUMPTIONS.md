...
| Parameter | Value | Range | Rationale |
|---|---|---|---|
| `reserve_volunteer_deployable_fraction` · Reservists who actually deploy | 0.5 | 0.4 – 0.75 | Since October 2016 the Army Reserve 'trained' strength counts anyone who has completed Phase 1 (SPS note 32), so part of it is not trade-trained; 1,720 are already on full-time service and 615 already mobilised; medical downgrades and employer or family exemptions remove more. |
...
| `ex_regular_report_ceiling` · Ex-regulars who ever report | 0.5 | 0.3 – 0.7 | The MoD has acknowledged that address records for the Regular Reserve are incomplete; medical and age exemptions remove more. |
...
| Parameter | Value | Range | Rationale |
|---|---|---|---|
| `gdp_age_multiplier_18_25` · Output multiplier, 18–25 | 0.6 | 0.5 – 0.7 | Lower employment rates and earnings among the youngest workers. |
| `gdp_age_multiplier_18_30` · Output multiplier, 18–30 | 0.75 | 0.65 – 0.85 | Design brief. |
| `gdp_age_multiplier_18_40` · Output multiplier, 18–40 | 0.9 | 0.8 – 1 | Design brief. |
| `gdp_age_multiplier_18_65` · Output multiplier, 18–65 | 1 | 1 – 1 | Design brief. |
